...
public class CartServiceImpl implements CartService {
    ...
    public void addCart(Cart cart) {
        ...
        if(hashOps.hasKey(skuId)){
            ...
            cart.setCheck(true);
            // 营销信息
            Resp<List<ItemSaleVO>> itemSaleVOResp = this.smsClient.queryItemSaleBySkuId(cart.getSkuId());
            ...
            List<SkuSaleAttrValueEntity> attrValueEntityList = listResp.getData();
            cart.setSaleAttrs(attrValueEntityList);
            //设置价格
    ...
    public List<Cart> queryCarts() {
        ...
        BoundHashOperations<String, Object, Object> loginOps = this.redisTemplate.boundHashOps(KEY_PREFIX + userId);
